  ...
  if (node.type === "table" && node.rows) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "table",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: node.rows.map((row, ri) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: row.map((cell, ci) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "td",
          {
            style: {
              ...
              padding: "7px 10px",
              textAlign: "center",
              background: ri === 0 ? "#f0f4ff" : ri % 2 === 0 ? "#fafafa" : "#fff",
...
function generatePDF(pages, setIsDownloading) {
  ...
  try {
    ...
    const addWrapped = (text, size, style2, lh, indent = 0) => {
      doc.setFontSize(size);
      doc.setFont("helvetica", style2);
      const lines = doc.splitTextToSize(text, PAGE_W - indent);
      for (const line of lines) {
        checkBreak(lh);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-1/2 flex flex-col", style: { background: "#e8e8e8" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "preview-content", style: { width: `${A4_WIDTH_PX}px` }, children: pages.map((pageNodes, idx) => {
              var _a2;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                PageView,
                {
                ...
                ((_a2 = pageNodes[0]) == null ? void 0 : _a2.id) ?? `page-${idx}`
              );
            }) })
          }
        )
