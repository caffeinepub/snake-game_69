...
function parseMarkup(input) {
  ...
  for (const line of lines) {
    if (line.startsWith("#ACTIVITY")) {
      ...
      const cols = line.replace("#ROW", "").split("|").map((c) => c.trim());
      if (currentTable) {
...
function TableNode({ rows }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "table",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.map((row, rIdx) => {
        const rowKey = `row-${rIdx}`;
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "tr",
          {
            style: {
              background: rIdx === 0 ? "#f0f4ff" : rIdx % 2 === 0 ? "#fafafa" : "#fff"
            },
...
function PageView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1 }, children: nodes.map((node) => renderNode(node)) }),
...
function renderNode(node) {
  ...
  if (node.type === "table" && node.rows) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(TableNode, { rows: node.rows }, node.id);
  }
  if (node.type === "plain") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
...
function renderNodeToPDF(pdf, node, yIn, pageNumRef) {
  let y = yIn;
  const maybeNewPage = (neededHeight) => {
  ...
  if (node.type === "activity") {
    ...
    pdf.setFontSize(13);
    pdf.setFont("helvetica", "bold");
    const lines = pdf.splitTextToSize(node.content ?? "", 180);
    ...
    pdf.setFontSize(12);
    pdf.setFont("helvetica", "normal");
    const lines = pdf.splitTextToSize(node.content ?? "", 177);
...
function AutoPDFGenerator() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-6 py-3 bg-card border-b border-border shadow-xs shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileDown, { className: "w-5 h-5 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-lg font-bold text-foreground tracking-tight", children: "Smart PDF Generator" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-1/2 flex flex-col border-r border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 bg-muted border-b border-border text-xs font-medium text-muted-foreground uppercase tracking-wide", children: "Markup Input" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-1/2 flex flex-col", style: { background: "#e8e8e8" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2 bg-muted border-b border-border text-xs font-medium text-muted-foreground uppercase tracking-wide flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "A4 Preview" }),
          hasContent && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground normal-case", children: [
            pages.length,
            " page",
            pages.length > 1 ? "s" : "",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: !hasContent ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center justify-center gap-4 text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FileDown, { className: "w-12 h-12 opacity-20" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-sm", children: "No preview yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", children: "Type markup in the editor and click Preview" })
              ] })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: previewRef, style: { width: `${A4_WIDTH_PX}px` }, children: pages.map((pageNodes, idx) => {
              var _a2;
              return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pdf-page", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                PageView,
                {
                  nodes: pageNodes,
                  pageNum: idx + 1,
              ...
              ) }, ((_a2 = pageNodes[0]) == null ? void 0 : _a2.id) ?? "page");
            }) })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "text-center py-2 text-xs text-muted-foreground bg-card border-t border-border shrink-0", children: "Developed by Appu | 2026" })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AutoPDFGenerator, {});
}
...
Service({
  "getHighScore": Func([], [Nat], ["query"]),
  "submitScore": Func([Nat], [Bool], [])
});
